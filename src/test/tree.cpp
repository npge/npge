...
BOOST_AUTO_TEST_CASE (tree_nj) {
    ...
    BOOST_CHECK(almost_equal(a2->length(), 2.0));
    BOOST_CHECK(almost_equal(a3->length(), 2.5));
    BOOST_CHECK(a1->parent() == a2->parent());
    BOOST_CHECK(almost_equal(a1->parent()->length(), 2.5));
}
