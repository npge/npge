...
BOOST_AUTO_TEST_CASE (Block_main) {
    ...
    Fragment* f1 = Fragment::create_new(s1, 2, 6, 1);
    Fragment* f2 = Fragment::create_new(s1, 9, 13, -1);
...
BOOST_AUTO_TEST_CASE (Block_join) {
    ...
    Block* b1 = Block::create_new();
    Block* b2 = Block::create_new();
    Fragment* f11 = Fragment::create_new(s1, 1, 2);
    Fragment* f12 = Fragment::create_new(s2, 1, 2);
    Fragment* f21 = Fragment::create_new(s1, 3, 4);
    Fragment* f22 = Fragment::create_new(s2, 3, 4);
    b1->insert(f11);
    b1->insert(f12);
    b2->insert(f21);
    b2->insert(f22);
    ...
    Block* new_block = Block::join(b1, b2, 1);
...
BOOST_AUTO_TEST_CASE (Block_try_join) {
    ...
    Fragment* f11 = Fragment::create_new(s1, 1, 2);
    Fragment* f12 = Fragment::create_new(s2, 1, 2);
    Fragment* f21 = Fragment::create_new(s1, 3, 4, -1);
    Fragment* f22 = Fragment::create_new(s2, 3, 4, -1);
    b1->insert(f11);
    b1->insert(f12);
    b2->insert(f21);
    b2->insert(f22);
    Fragment::connect(f11, f21);
    Fragment::connect(f12, f22);
    Block* new_block = Block::try_join(b1, b2);
...
BOOST_AUTO_TEST_CASE (Block_try_join_max_gap) {
    ...
    Fragment* f11 = Fragment::create_new(s1, 1, 2);
    Fragment* f12 = Fragment::create_new(s2, 1, 2);
    Fragment* f21 = Fragment::create_new(s1, 4, 4, -1);
    Fragment* f22 = Fragment::create_new(s2, 4, 4, -1);
    b1->insert(f11);
    b1->insert(f12);
    b2->insert(f21);
    b2->insert(f22);
    ...
    Block* new_block = Block::try_join(b1, b2, &dist_0);
    BOOST_CHECK(!new_block);
    delete b1;
    delete b2;
}
...
BOOST_AUTO_TEST_CASE (Block_inverse) {
    ...
    SequencePtr s1 = boost::make_shared<InMemorySequence>("tGGtccgagcggacggcc");
    SequencePtr s2 = boost::make_shared<InMemorySequence>("tGGtccgagcggacggcc");
    Block* b = Block::create_new();
    Fragment* f1 = Fragment::create_new(s1, 1, 2);
    Fragment* f2 = Fragment::create_new(s2, 1, 2);
    b->insert(f1);
    b->insert(f2);
    b->inverse();
...
BOOST_AUTO_TEST_CASE (Block_max_shift_end_two_blocks) {
    ...
    b1->insert(f12);
    Block* b2 = Block::create_new();
    Fragment* f21 = Fragment::create_new(s1, 11, 12);
    Fragment* f22 = Fragment::create_new(s2, 6, 7);
    b2->insert(f21);
    b2->insert(f22);
    Fragment::connect(f11, f21);
    Fragment::connect(f12, f22);
...
BOOST_AUTO_TEST_CASE (Block_expand_3) {
    ...
    Fragment* f1 = Fragment::create_new(s1, 1, 2);
    Fragment* f2 = Fragment::create_new(s2, 1, 2);
    Fragment* f3 = Fragment::create_new(s3, 1, 2);
    b->insert(f1);
    b->insert(f2);
    b->insert(f3);
...
BOOST_AUTO_TEST_CASE (Block_expand_overlap) {
    ...
    SequencePtr s2 = boost::make_shared<InMemorySequence>("tGGTCCGAGCGGAcggcc");
    Block* b1 = Block::create_new();
    Fragment* f11 = Fragment::create_new(s1, 1, 5);
    Fragment* f12 = Fragment::create_new(s2, 1, 5);
    b1->insert(f11);
    b1->insert(f12);
    Block* b2 = Block::create_new();
    Fragment* f21 = Fragment::create_new(s1, 3, 12);
    Fragment* f22 = Fragment::create_new(s2, 3, 12);
    b2->insert(f21);
    b2->insert(f22);
    Fragment::connect(f11, f21);
    Fragment::connect(f12, f22);
...
BOOST_AUTO_TEST_CASE (Block_expand_blocks_by_fragments_length_1) {
    ...
    SequencePtr s2 = boost::make_shared<InMemorySequence>("tGgtccgagcggacggcc");
    Block* b1 = Block::create_new();
    Fragment* f11 = Fragment::create_new(s1, 1, 1);
    Fragment* f12 = Fragment::create_new(s2, 1, 1);
    b1->insert(f11);
    b1->insert(f12);
    Block* b2 = Block::create_new();
    Fragment* f21 = Fragment::create_new(s1, 11, 11);
    b2->insert(f21);
    Fragment::connect(f11, f21);
    BOOST_CHECK(b2->expand_by_fragments());
    BOOST_CHECK(b2->size() == 2);
...
BOOST_AUTO_TEST_CASE (Block_expand_blocks_by_fragments_high) {
    ...
    Block* b2 = Block::create_new();
    Fragment* f21 = Fragment::create_new(s1, 11, 12);
    Fragment* f22 = Fragment::create_new(s2, 11, 12);
    b2->insert(f21);
    b2->insert(f22);
    Fragment::connect(f11, f21);
    Fragment::connect(f12, f22);
...
BOOST_AUTO_TEST_CASE (Block_expand_blocks_by_fragments_self_neighbor) {
    ...
    Fragment* f11 = Fragment::create_new(s1, 0, 0);
    Fragment* f12 = Fragment::create_new(s1, 2, 2);
    Fragment* f13 = Fragment::create_new(s1, 4, 4);
    Fragment* f14 = Fragment::create_new(s1, 6, 6);
    Fragment* f15 = Fragment::create_new(s1, 8, 8);
    Block* b = Block::create_new();
    b->insert(f11);
    b->insert(f12);
    b->insert(f13);
...
BOOST_AUTO_TEST_CASE (Block_merge) {
    ...
    Fragment* f13 = Fragment::create_new(s1, 4, 4);
    Fragment* f21 = Fragment::create_new(s1, 4, 4, -1);
    Fragment* f22 = Fragment::create_new(s1, 6, 6, -1);
    Fragment* f23 = Fragment::create_new(s1, 8, 8, -1);
    Block* b1 = Block::create_new();
    b1->insert(f11);
    b1->insert(f12);
    b1->insert(f13);
